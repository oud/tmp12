...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'bd97dab9-4254-4661-8e3a-491ac9132e32' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('4d94e9cd-77c4-411d-8141-4bcae014d280');
      cy.get(`[data-cy="name"]`).should('have.value', '4d94e9cd-77c4-411d-8141-4bcae014d280');
