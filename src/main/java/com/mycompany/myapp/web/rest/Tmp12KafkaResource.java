...
@RestController
@RequestMapping("/api/tmp-12-kafka")
public class Tmp12KafkaResource {

    private static final String PRODUCER_BINDING_NAME = "binding-out-0";

    private static final Logger LOG = LoggerFactory.getLogger(Tmp12KafkaResource.class);
    private final KafkaConsumer kafkaConsumer;
    private final StreamBridge streamBridge;

    public Tmp12KafkaResource(StreamBridge streamBridge, KafkaConsumer kafkaConsumer) {
